                    ...
                    <div>
                        <form className='pb-3'>
                            <div className="form-group d-flex flex-column align-items-center m-2">
                                ...
                                <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder=" مهدی کشاورزی" />
                                <small id="emailHelp" class="form-text " style={{ color: 'white' }}>وارد کردن نام اجباری است!</small>
                                {/* if we want to mute a text =>text-muted */}
                            </div>
                            <div className='d-flex flex-column align-items-center m-3'>
                                <label for="exampleInputEmail1">شماره همراه:</label>
                                <input id="typeNumber" type="number" class="form-control" placeholder='۰۹۱۲۳۴۵۶۷۸۹' />
                                <small id="emailHelp" class="form-text " style={{ color: 'white' }}> وارد کردن شماره همراه اجباری است!</small>

                            </div>
                            <div className="form-group d-flex flex-column align-items-center m-3">
                                <label for="exampleInputPassword1">رمز عبور</label>
                                <input type="password" class="form-control" id="exampleInputPassword1" placeholder="*****w" />
                            </div>
