...
import datas from "../FOODcard.json" // Adjust the path as necessary
import "./Materia.css"
...
const Comments = () => {
    const { id } = useParams();
    const foodId = parseInt(id, 10); // Make sure this matches the type in your JSON

    const food = datas.foods.find((item) => item.id === foodId);
...
>
                    ...
                    <div className='comments p-3'>
                        <div className='bg-light rounded p-2 idea'>
                            <div >
                                <textarea class="bg-light textarea" id="exampleFormControlTextarea1" placeholder='دیدگاه خود را اضافه کنید...' rows="3"></textarea>
                            </div>
                        </div>
            ...
            <div className='background p-5 col-9'>
                <div className='container bg-white  rounded p-4'>
                    <div className='d-flex flex-column '>
                        <img className='image' src={food.src} alt='food' />
                    ...
                    <div className='d-flex justify-content-between align-items-center'>
                        ...
                        <div >
                            <img src={bag} alt='bg' className='bag p-1 mx-2' />
                        </div>
                        </div>
                    </div>
                </div>
